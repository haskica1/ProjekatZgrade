...
public class BuildingManagementDAO {
    ...
    private BuildingManagementDAO(){
        ...
        try{
            ...
            getBuildingsIdFromMuncipalites=conn.prepareStatement("select municipalityId from Building_Muncipality where buildingId=?");
            ...
            updateMuncipalityBuilding = conn.prepareStatement("update Building_Muncipality set buildingId = ? where municipalityId = ?");
            deleteMuncipalityBuilding = conn.prepareStatement("delete from Building_Muncipality where municipalityId = ?");
            deleteBuildingMuncipality = conn.prepareStatement("delete from Building_Muncipality where buildingId = ?");
            getMuncipalityFromBM = conn.prepareStatement("select Municipality.id, Municipality.name, Municipality.numberBuildings from Municipality, Building_Muncipality where Building_Muncipality.buildingId = Municipality.id and Building_Muncipality.municipalityId = ?");
            getAllBuildingsFromUser = conn.prepareStatement("select Building.id, Building.adress, Building.numberOfFlats, Building.type, Building.garage,Building.numberOfElevators,Building.numberOfFloors, Building.yearOfBuilt, Building.guest_id from Building, User_Muncipality,Building_Muncipality,User where User_Muncipality.idUser = User.id and User_Muncipality.idMuncipality = Building_Muncipality.buildingId and Building_Muncipality.municipalityId = Building.id and User.id = ?");
            ...
            getIdMunicipalityFromBuilding_Municipality = conn.prepareStatement("select buildingId from Building_Muncipality where municipalityId=?");
